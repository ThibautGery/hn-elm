...
/***/ function(module, exports) {
	...
	var _ThibautGery$hn_elm$Posts_List$linkToHn = function (post) {
		return _elm_lang$core$String$concat(
			{
				ctor: '::',
				_0: 'https://news.ycombinator.com/item?id=',
				_1: {
					ctor: '::',
					_0: _elm_lang$core$Basics$toString(post.id),
					_1: {ctor: '[]'}
				}
			});
	};
	var _ThibautGery$hn_elm$Posts_List$discution = function (post) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('two wide column'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$a,
					{
						...
						_0: _elm_lang$html$Html_Attributes$href(
							_ThibautGery$hn_elm$Posts_List$linkToHn(post)),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$String$concat(
								{
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(post.descendants),
									_1: {
										ctor: '::',
										_0: ' comments',
										_1: {ctor: '[]'}
	...
	var _ThibautGery$hn_elm$Posts_List$author = function (post) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
	...
	var _ThibautGery$hn_elm$Posts_List$title = function (post) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
	...
	var _ThibautGery$hn_elm$Posts_List$votes = function (post) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('ui mini statistic'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('one wide column'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _ThibautGery$hn_elm$Posts_List$votes(post),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('ui fifteen wide column grid'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _ThibautGery$hn_elm$Posts_List$title(post),
							_1: {
								ctor: '::',
								_0: _ThibautGery$hn_elm$Posts_List$author(post),
								_1: {
									ctor: '::',
									_0: _ThibautGery$hn_elm$Posts_List$discution(post),
									_1: {ctor: '[]'}
								}
							}
						}),
	...
	var _ThibautGery$hn_elm$View$header = A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$href('/hn-elm/'),
					_1: {
						ctor: '::',
				...
				},
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text('Elmer News'),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
	...
	var _ThibautGery$hn_elm$View$view = function (model) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('ui vertical masthead aligned segment'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _ThibautGery$hn_elm$View$header,
						_1: {
							ctor: '::',
							_0: A2(
